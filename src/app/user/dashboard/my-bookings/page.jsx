...
import { FiClock, FiMapPin, FiInbox, FiLoader } from "react-icons/fi";
...
function BookingCard({ booking }) {
  ...
  const handleStripeCheckout = async () => {
    ...
    try {
      ...
      // Derived math to prevent Stripe over-billing calculation errors
      ...
      // Handoff checkout runtime context instantly to Stripe's secure cloud interface
